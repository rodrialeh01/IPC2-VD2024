class ListaCabecera:
    ...
    def insertarNodoCabecera(self, nuevo):
        if self.primero == None and self.ultimo == None:
            ...
            #-- VERIFICAMOS SI EL NUEVO NODO ES MENOR QUE EL PRIMER NODO
            ...
            #-- VERIFICAMOS SI EL NUEVO NODO ES MAYOR QUE EL ULTIMO NODO
                ...
                self.ultimo = nuevo
            #-- SINO, RECORREMOS LA LISTA PARA BUSCAR DONDE ACOMODAR EL NUEVO NODO CABECERA QUE SE UBICA ENTRE EL PRIMERO Y EL ULTIMO
            else:
                actual = self.primero
                while actual != None:
